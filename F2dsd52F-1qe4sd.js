    document.addEventListener("DOMContentLoaded", function() {
        ...
        const loadAd = (containerId, client, slot) => {
        ...
        const loadAllAds = () => {
            try {
                loadAd('ad-container-1', ad_client_1, ad_slot_1);
                loadAd('ad-container-2', ad_client_2, ad_slot_2);
                loadAd('ad-container-3', ad_client_3, ad_slot_3);
            } catch (e) {
